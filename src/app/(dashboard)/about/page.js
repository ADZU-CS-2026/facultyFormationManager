                    ...
                    <div className="col-md-6">
                      <div className="card shadow-sm border-0 p-4 text-wrap text-break">
                        <p className="small lh-base m-0">
                          ...
                          various formation offices and departments within the university. The
                          Unit Director plays a pivotal role in the development and implementation
                          of holistic formation programs and activities, which encompass spiritual,
                          psycho-emotional, social action, and coaching initiatives.
                        </p>
                      </div>
                    </div>
                ...
                <div className="mt-5">
                  ...
                  <div className="card shadow-sm border-0 p-4">
                    <ul className="small lh-lg m-0 ps-3">
                      <li>Social Awareness and Community Service Involvement Formation Program (SACSI) Office</li>
                      ...
                      <li>University Church of the Sacred Heart of Jesus (UCSHJ)</li>
                    </ul>
                  </div>
                </div>
