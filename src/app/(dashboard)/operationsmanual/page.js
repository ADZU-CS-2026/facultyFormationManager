          ...
          <div className="card border-0 border-top border-secondary border-opacity-50 border-3 rounded-1 shadow-sm">
            ...
            {/* OFFICE POLICIES CARD */}
              <div className="card shadow-sm rounded-2 border-0 mb-4 p-4 text-wrap text-break">
                ...
                <p className="small lh-base mb-0" style={{ textAlign: "justify"}}>
                  The Unit Director for Formation and Support Staff are required to wear the uniform prescribed by the Human Resource Administration and Development Office from Monday to Saturday as stated in the Administrative Manual.
                </p>
              </div>
              ...
              <div className="card shadow-sm rounded-2 border-0 mb-4 p-4 text-wrap text-break">
                ...
                <p className="small lh-base mb-0" style={{ textAlign: "justify"}}>
                  Annual budget preparation starts in October. A pre-requisite document for the budget preparation is the operational plan of the previous year and that of the coming year. All budget proposals are to be anchored in the operational plan of the office and within the five-year target performance. Units and offices under the formation unit will have to work on their budget preparation using the same procedure to ensure quality assurance of the different programs and activities.
                </p>
              </div>
              ...
              <div className="card shadow-sm rounded-2 border-0 mb-4 p-4 text-wrap text-break">
                ...
                <p className="small lh-base mb-3" style={{ textAlign: "justify"}}>
                  Implementing these protocols can enhance communication, foster collaboration, and create a more efficient office environment. In the Unit Director for Formation office, we practice several communication protocols:
                </p>

                <ol className="list-decimal list-inside mb-3 small" style={{ textAlign: "justify"}}>
                  <li><strong>Email Communication Protocols</strong>: Staff must check their emails every morning and update the director about any important messages. Any official concerns must be directed via email.</li>
                  <li><strong>Social Media Protocols</strong>: All content shared on social media via the official Facebook page must be approved by the Director or an appointed social media coordinator. Posts should align with the values and mission of the university.</li>
                  <li><strong>Instant Messaging Protocols</strong>: Staff can use instant messaging platforms to communicate emergency, urgent, or important matters to the director.</li>
                  <li><strong>Feedback and Performance Communication Protocols</strong>: The director holds one-on-one meetings with staff to discuss performance and identify areas for improvement.</li>
                  <li><strong>Conflict Resolution Protocols</strong>: The director maintains a neutral stance and is open to individual consultations. Staff conflicts should be discussed with the director, and serious matters may be referred to the Human Resource Administration and Development Office.</li>
                  <li><strong>
                    Regular Meeting Protocols</strong>:
                    <ol className="list-disc list-inside mt-2 ps-3"  style={{ textAlign: "justify"}} type="a">
                      <li><strong>University Formation Management Council Meeting</strong>: Scheduled every quarter; additional meetings may be called by the Unit Director.</li>
                      <li><strong>Monthly Tuesdays Meeting</strong>: Morning for higher education formation group, afternoon for basic education formation group; for updates, clarifications, and preparation for activities.</li>
                      <li><strong>Monday Toolbox Meeting</strong>: Staff meets with the Unit Director to review weekly business, updates, and calendar of activities.</li>
                    </ol>
                  </li>
                </ol>
              </div>
