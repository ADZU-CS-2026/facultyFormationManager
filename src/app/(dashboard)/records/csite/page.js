      ...
      <div className="row g-0">
        <div className="col-12 py-4 px-3">
            ...
            <div className="text-gray1 border-bottom p-2 px-3 fs-6 d-flex justify-content-between align-items-center">
                College of Sciene and Information Technology and Engineering
            </div>
            <div className="py-4 px-3 small g-0">
                <div className="fs-5 text-center mb-4">Days with God Faculty of Higher Education Profile</div>
             ...
             <div className="border fs-6 text-center py-2">College of Sciene and Information Technology and Engineering</div>
